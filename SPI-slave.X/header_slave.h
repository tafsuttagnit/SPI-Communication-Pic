...
// CONFIG1L
 ...
 #pragma config USBDIV = 0 //2 // USB Clock Selection bit (used in Full-Speed USB mode only; UCFG:FSEN = 1) (USB clock source comes from the 96 MHz PLL divided by 2)
// CONFIG1H
 ///#pragma config FOSC = HS//INTOSC_EC // Internal oscillator, CLKO function on RA6, EC used by USB (INTCKO)*/
